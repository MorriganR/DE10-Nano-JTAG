...
# Create a new driver
create_driver jtag_adc_driver

# Associate it with some hardware known as "jtag_adc"
set_sw_property hw_class_name jtag_adc
...
# C/C++ source files
#add_sw_property c_source HAL/src/jtag_adc.c

# Include files
#add_sw_property include_source HAL/inc/jtag_adc.h
add_sw_property include_source inc/jtag_adc_regs.h
